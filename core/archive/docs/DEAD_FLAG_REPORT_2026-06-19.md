...
| `last_checked_at` | db.js:139 (migration), translation-db.js:307 (UPSERT), :318 (CURRENT_TIMESTAMP) | ✅ preflight.js countIssues(): `WHERE last_checked_at IS NULL` (BU-035) | ❌ | **AKTIV** (diagnostic) |
...
| `stress_tested_at` | translation-db.js:144 (CURRENT_TIMESTAMP) | ✅ preflight.js countIssues(): `WHERE stress_tested_at IS NULL` (BU-035) | ❌ | **AKTIV** (diagnostic) |
