...
| Datei | Groesse |
|---|---|
| frozen_watermark-config.js | 851 B |
| frozen_text-core.js | 21.9 KB |
| frozen_exporter.js | 6.5 KB |
| frozen_SongsOfSyxPlugin.js | 9.7 KB |
| frozen_verify_watermark.js | 6.1 KB |
| SECURITY_ARCHIVE.md | -- |
...
**Archiv:** frozen_watermark-config.js
...
**Pfad:** verify_watermark.js
**Bugfix:** ZWNJ-Konstante war referenziert aber nie definiert.

| Modus | Befehl |
|---|---|
| Normal | node verify_watermark.js <datei|verzeichnis> |
| Forensik | node verify_watermark.js --forensic <datei> |
