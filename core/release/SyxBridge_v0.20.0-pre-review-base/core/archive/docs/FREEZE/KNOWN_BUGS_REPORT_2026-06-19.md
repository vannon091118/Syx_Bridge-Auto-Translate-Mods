...
> ⚠️ **DEPRECATED (post-v0.20 — 2026-06-19):** Die nachfolgende F1-F5-Liste ist **superseded** durch [`POST_V020_RE_AUDIT_2026-06-19.md`](POST_V020_RE_AUDIT_2026-06-19.md) (mit F.A-F.D Findings als operative Sicht). Die historischen F1-F5 → BUG-FS-NNN Mappings bleiben für Reproduzierbarkeit **eingefroren**, sind aber nicht mehr Quelle der operativen Audit-Sicht.
